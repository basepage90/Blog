...
export default function ResultCardMobile({data}: ResultCardMobileProps){
    ...
    const { searchwordMobile } = useSelector( (state: RootState) => ({ searchwordMobile: state.search.searchwordMobile }) );
