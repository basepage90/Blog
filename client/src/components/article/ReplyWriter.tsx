...
const NameField = styled(TextField)<{id: string}>`
  flex: 1 1 auto;
  max-width: 46%;
  ime-mode: active;
...
const CountDescSpan = styled.span<{ currentLength: number, maxLength: number }>`
...
const ReplyWriter = ({replyId,admin_flag,doCreateReply}: ReplyWriterProps) => {
  ...
  const countLength = ( e: React.ChangeEvent<HTMLInputElement> ) => {
