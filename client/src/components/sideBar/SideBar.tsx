...
function SideBar(){
    ...
    useEffect(() => {
        ...
        if( mobileFlag ){
            outside !== null && outside.addEventListener('click', outsideClick);
        }
        ...
        return () => { // componentWillUnmount
            ...
            if( mobileFlag ){
                outside !== null && outside.removeEventListener('click', outsideClick);
            }
        }
    });

    const mobile: {[key: string]: any} = {
        outside: {
